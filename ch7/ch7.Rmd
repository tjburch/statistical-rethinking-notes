...
Comparing two models ($q$ and $r$), this is easy to get out of - $p$ substracts out. We compare average log-probability from each model to get an estimate of relative distance from each to the target. In this, magnitudes are worthless, but difference is useful. For model $q$:
